    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservaAreas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservaAreas_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservasImplementos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservasImplementos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservaAreas_UserId",
                table: "ReservaAreas",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservasImplementos_UserId",
                table: "ReservasImplementos",
                column: "UserId");
        }
